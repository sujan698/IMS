...
export class OrganizationsService {
  ...
  async create(createOrganizationDto: CreateOrganizationDto) {
    createOrganizationDto.name = capatalizeFirstLetterOfEachWordInAphrase(
      createOrganizationDto.name,
    );
    if (createOrganizationDto.address) {
      createOrganizationDto.address = capatalizeFirstLetterOfEachWordInAphrase(
  ...
  async update(id: number, updateOrganizationDto: UpdateOrganizationDto) {
    ...
    updateOrganizationDto.name = capatalizeFirstLetterOfEachWordInAphrase(
      updateOrganizationDto.name,
    );
    if (updateOrganizationDto.address) {
      updateOrganizationDto.address = capatalizeFirstLetterOfEachWordInAphrase(
    ...
    if (
      ...
      throw new BadRequestException(
        `Organization ${updateOrganizationDto.name}has alrready been taken`,
      );
    }
